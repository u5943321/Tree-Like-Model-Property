...
- Partition_Alt: The lemmas provided by the existing library does not allow quotienting a set A by a relation that relates elements beyond A. This file provides lemmas that remove that restriction. This is a minor modification to make the partition lemmas easier to use.
